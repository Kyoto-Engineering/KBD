...
namespace PhonebookApp.Reports
{
    ...
    public partial class ReportByGroupforEidGreeting : Form
    {
        ...
        public int GroupId;
        public ReportByGroupforEidGreeting()
        {
            InitializeComponent();
        }

        private void ReportByGroupforEidGreeting_Load(object sender, EventArgs e)
        {
            try
            {
