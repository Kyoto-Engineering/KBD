...
{
    public partial class NewLOIforAutomatedTrafficLightUI : Form
    {
        ...
        public int GroupId;
        public NewLOIforAutomatedTrafficLightUI()
        {
            InitializeComponent();
        }

        private void NewLOIforAutomatedTrafficLightUI_Load(object sender, EventArgs e)
        {
            try
            {
